...
from ..models.rhub_api_tower_webhook_notification_json_body_hosts_additional_property import (
...
class RhubApiTowerWebhookNotificationJsonBodyHosts:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = copy(src_dict)
        rhub_api_tower_webhook_notification_json_body_hosts = cls()
        ...
        rhub_api_tower_webhook_notification_json_body_hosts.additional_properties = additional_properties
        return rhub_api_tower_webhook_notification_json_body_hosts
