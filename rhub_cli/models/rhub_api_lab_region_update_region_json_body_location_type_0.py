...
from ..models.rhub_api_lab_region_update_region_json_body_location_type_0_id import (
...
class RhubApiLabRegionUpdateRegionJsonBodyLocationType0:
    ...
    Attributes:
        ...
        id (Union[Unset, RhubApiLabRegionUpdateRegionJsonBodyLocationType0Id]):
        name (Union[Unset, str]): Short name of location / IATA identifier / ... Example: RDU.
    """

    description: Union[Unset, None, str] = UNSET
    id: Union[Unset, RhubApiLabRegionUpdateRegionJsonBodyLocationType0Id] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_id, Unset):
            ...
            id = RhubApiLabRegionUpdateRegionJsonBodyLocationType0Id.from_dict(_id)
