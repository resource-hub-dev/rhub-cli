...
from ..models.rhub_api_tower_relaunch_job_response_200_id import RhubApiTowerRelaunchJobResponse200Id
from ..types import UNSET, Unset

T = TypeVar("T", bound="RhubApiTowerRelaunchJobResponse200")


@attr.s(auto_attribs=True)
class RhubApiTowerRelaunchJobResponse200:
    """
    Attributes:
        ...
        id (Union[Unset, RhubApiTowerRelaunchJobResponse200Id]): Internal ID
    ...
    id: Union[Unset, RhubApiTowerRelaunchJobResponse200Id] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _id = d.pop("id", UNSET)
        id: Union[Unset, RhubApiTowerRelaunchJobResponse200Id]
        if isinstance(_id, Unset):
            id = UNSET
        else:
            id = RhubApiTowerRelaunchJobResponse200Id.from_dict(_id)
        ...
        rhub_api_tower_relaunch_job_response_200 = cls(
        ...
        rhub_api_tower_relaunch_job_response_200.additional_properties = d
        return rhub_api_tower_relaunch_job_response_200
