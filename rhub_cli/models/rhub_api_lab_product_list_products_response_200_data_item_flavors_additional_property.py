...
T = TypeVar("T", bound="RhubApiLabProductListProductsResponse200DataItemFlavorsAdditionalProperty")


@attr.s(auto_attribs=True)
class RhubApiLabProductListProductsResponse200DataItemFlavorsAdditionalProperty:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_product_list_products_response_200_data_item_flavors_additional_property = cls(
            num_vcpus=num_vcpus,
        ...
        rhub_api_lab_product_list_products_response_200_data_item_flavors_additional_property.additional_properties = d
        return rhub_api_lab_product_list_products_response_200_data_item_flavors_additional_property
