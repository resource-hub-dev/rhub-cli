...
from ..models.rhub_api_auth_group_list_group_users_response_200_item_id import (
...
class RhubApiAuthGroupListGroupUsersResponse200Item:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_auth_group_list_group_users_response_200_item = cls(
            email=email,
            enabled=enabled,
        ...
        rhub_api_auth_group_list_group_users_response_200_item.additional_properties = d
        return rhub_api_auth_group_list_group_users_response_200_item
