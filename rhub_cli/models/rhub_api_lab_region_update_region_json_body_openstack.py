...
from ..models.rhub_api_lab_region_update_region_json_body_openstack_credentials_type_0 import (
...
class RhubApiLabRegionUpdateRegionJsonBodyOpenstack:
    """
    Attributes:
        credentials (Union[RhubApiLabRegionUpdateRegionJsonBodyOpenstackCredentialsType0, Unset, str]):  Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_credentials(
            data: object,
        ) -> Union[RhubApiLabRegionUpdateRegionJsonBodyOpenstackCredentialsType0, Unset, str]:
            ...
            try:
                ...
                if isinstance(_credentials_type_0, Unset):
                    ...
                    credentials_type_0 = RhubApiLabRegionUpdateRegionJsonBodyOpenstackCredentialsType0.from_dict(
                        _credentials_type_0
                    )
        ...
        rhub_api_lab_region_update_region_json_body_openstack = cls(
        ...
        rhub_api_lab_region_update_region_json_body_openstack.additional_properties = d
        return rhub_api_lab_region_update_region_json_body_openstack
