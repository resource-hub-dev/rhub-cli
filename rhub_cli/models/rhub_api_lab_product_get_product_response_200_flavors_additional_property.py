...
T = TypeVar("T", bound="RhubApiLabProductGetProductResponse200FlavorsAdditionalProperty")


@attr.s(auto_attribs=True)
class RhubApiLabProductGetProductResponse200FlavorsAdditionalProperty:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_product_get_product_response_200_flavors_additional_property = cls(
            num_vcpus=num_vcpus,
        ...
        rhub_api_lab_product_get_product_response_200_flavors_additional_property.additional_properties = d
        return rhub_api_lab_product_get_product_response_200_flavors_additional_property
