...
T = TypeVar("T", bound="RhubApiLabRegionGetUsageResponse200UserQuotaType0")


@attr.s(auto_attribs=True)
class RhubApiLabRegionGetUsageResponse200UserQuotaType0:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_region_get_usage_response_200_user_quota_type_0 = cls(
            num_vcpus=num_vcpus,
        ...
        rhub_api_lab_region_get_usage_response_200_user_quota_type_0.additional_properties = d
        return rhub_api_lab_region_get_usage_response_200_user_quota_type_0
