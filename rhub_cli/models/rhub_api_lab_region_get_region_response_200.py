...
from ..models.rhub_api_lab_region_get_region_response_200_satellite_type_0 import (
    RhubApiLabRegionGetRegionResponse200SatelliteType0,
)
...
class RhubApiLabRegionGetRegionResponse200:
    ...
    Attributes:
        ...
        satellite (Union[Any, RhubApiLabRegionGetRegionResponse200SatelliteType0, Unset]):
    ...
    satellite: Union[Any, RhubApiLabRegionGetRegionResponse200SatelliteType0, Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.satellite, RhubApiLabRegionGetRegionResponse200SatelliteType0):
            satellite = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_satellite(data: object) -> Union[Any, RhubApiLabRegionGetRegionResponse200SatelliteType0, Unset]:
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                ...
                satellite_type_0: Union[Unset, RhubApiLabRegionGetRegionResponse200SatelliteType0]
                if isinstance(_satellite_type_0, Unset):
                    satellite_type_0 = UNSET
                else:
                    satellite_type_0 = RhubApiLabRegionGetRegionResponse200SatelliteType0.from_dict(_satellite_type_0)

                return satellite_type_0
            except:  # noqa: E722
                pass
            return cast(Union[Any, RhubApiLabRegionGetRegionResponse200SatelliteType0, Unset], data)
