...
from ..models.rhub_api_lab_cluster_list_cluster_hosts_response_200_item_cluster_id import (
    RhubApiLabClusterListClusterHostsResponse200ItemClusterId,
)
from ..models.rhub_api_lab_cluster_list_cluster_hosts_response_200_item_id import (
...
class RhubApiLabClusterListClusterHostsResponse200Item:
    ...
    id: Union[Unset, RhubApiLabClusterListClusterHostsResponse200ItemId] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_cluster_id, Unset):
            ...
            cluster_id = RhubApiLabClusterListClusterHostsResponse200ItemClusterId.from_dict(_cluster_id)
        ...
        if isinstance(_id, Unset):
            ...
            id = RhubApiLabClusterListClusterHostsResponse200ItemId.from_dict(_id)
