...
from ..models.rhub_api_lab_location_location_region_list_response_200_item_region_user_quota_type_0 import (
    RhubApiLabLocationLocationRegionListResponse200ItemRegionUserQuotaType0,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RhubApiLabLocationLocationRegionListResponse200ItemRegion")


@attr.s(auto_attribs=True)
class RhubApiLabLocationLocationRegionListResponse200ItemRegion:
    """
    Attributes:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.location, RhubApiLabLocationLocationRegionListResponse200ItemRegionLocationType0):
            location = UNSET
        ...
        elif isinstance(self.total_quota, RhubApiLabLocationLocationRegionListResponse200ItemRegionTotalQuotaType0):
            total_quota = UNSET
        ...
        elif isinstance(self.user_quota, RhubApiLabLocationLocationRegionListResponse200ItemRegionUserQuotaType0):
            user_quota = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_location(
            data: object,
        ) -> Union[Any, RhubApiLabLocationLocationRegionListResponse200ItemRegionLocationType0, Unset]:
            ...
            try:
                ...
                location_type_0: Union[Unset, RhubApiLabLocationLocationRegionListResponse200ItemRegionLocationType0]
                if isinstance(_location_type_0, Unset):
                    location_type_0 = UNSET
                else:
                    location_type_0 = RhubApiLabLocationLocationRegionListResponse200ItemRegionLocationType0.from_dict(
                        _location_type_0
                    )
                ...
                pass
            return cast(Union[Any, RhubApiLabLocationLocationRegionListResponse200ItemRegionLocationType0, Unset], data)
        ...
        def _parse_total_quota(
            data: object,
        ) -> Union[Any, RhubApiLabLocationLocationRegionListResponse200ItemRegionTotalQuotaType0, Unset]:
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                ...
                total_quota_type_0: Union[
                    Unset, RhubApiLabLocationLocationRegionListResponse200ItemRegionTotalQuotaType0
                ]
                if isinstance(_total_quota_type_0, Unset):
                    total_quota_type_0 = UNSET
                else:
                    total_quota_type_0 = (
                        RhubApiLabLocationLocationRegionListResponse200ItemRegionTotalQuotaType0.from_dict(
                            _total_quota_type_0
                        )
                    )
                ...
                pass
            return cast(
                Union[Any, RhubApiLabLocationLocationRegionListResponse200ItemRegionTotalQuotaType0, Unset], data
            )
        ...
        def _parse_user_quota(
            data: object,
        ) -> Union[Any, RhubApiLabLocationLocationRegionListResponse200ItemRegionUserQuotaType0, Unset]:
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                ...
                user_quota_type_0: Union[Unset, RhubApiLabLocationLocationRegionListResponse200ItemRegionUserQuotaType0]
                if isinstance(_user_quota_type_0, Unset):
                    user_quota_type_0 = UNSET
                else:
                    user_quota_type_0 = (
                        RhubApiLabLocationLocationRegionListResponse200ItemRegionUserQuotaType0.from_dict(
                            _user_quota_type_0
                        )
                    )
                ...
                pass
            return cast(
                Union[Any, RhubApiLabLocationLocationRegionListResponse200ItemRegionUserQuotaType0, Unset], data
            )
        ...
        return rhub_api_lab_location_location_region_list_response_200_item_region
