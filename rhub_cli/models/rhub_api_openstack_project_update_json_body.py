...
T = TypeVar("T", bound="RhubApiOpenstackProjectUpdateJsonBody")


@attr.s(auto_attribs=True)
class RhubApiOpenstackProjectUpdateJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_openstack_project_update_json_body = cls(
            cloud_id=cloud_id,
        ...
        rhub_api_openstack_project_update_json_body.additional_properties = d
        return rhub_api_openstack_project_update_json_body
