...
from ..models.rhub_api_lab_region_list_region_products_response_200_item_product_flavors_additional_property import (
...
class RhubApiLabRegionListRegionProductsResponse200ItemProductFlavors:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = copy(src_dict)
        rhub_api_lab_region_list_region_products_response_200_item_product_flavors = cls()
        ...
        rhub_api_lab_region_list_region_products_response_200_item_product_flavors.additional_properties = (
            additional_properties
        )
        return rhub_api_lab_region_list_region_products_response_200_item_product_flavors
