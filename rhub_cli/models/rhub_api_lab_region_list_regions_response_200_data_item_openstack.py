...
from ..models.rhub_api_lab_region_list_regions_response_200_data_item_openstack_credentials_type_0 import (
...
class RhubApiLabRegionListRegionsResponse200DataItemOpenstack:
    """
    Attributes:
        credentials (Union[RhubApiLabRegionListRegionsResponse200DataItemOpenstackCredentialsType0, Unset, str]):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.credentials, RhubApiLabRegionListRegionsResponse200DataItemOpenstackCredentialsType0):
            credentials = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_region_list_regions_response_200_data_item_openstack = cls(
        ...
        rhub_api_lab_region_list_regions_response_200_data_item_openstack.additional_properties = d
        return rhub_api_lab_region_list_regions_response_200_data_item_openstack
