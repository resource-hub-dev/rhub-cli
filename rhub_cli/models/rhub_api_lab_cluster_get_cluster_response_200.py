...
class RhubApiLabClusterGetClusterResponse200:
    ...
    Attributes:
        ...
        status_flag (Union[Unset, None, RhubApiLabClusterGetClusterResponse200StatusFlag]):
    """
    ...
    status_flag: Union[Unset, None, RhubApiLabClusterGetClusterResponse200StatusFlag] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _status_flag is None:
            ...
            status_flag = RhubApiLabClusterGetClusterResponse200StatusFlag(_status_flag)
