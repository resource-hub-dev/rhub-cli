...
from ..models.rhub_api_lab_region_update_region_json_body_dns_server_key_type_0 import (
...
class RhubApiLabRegionUpdateRegionJsonBodyDnsServer:
    ...
    Attributes:
        ...
        key (Union[RhubApiLabRegionUpdateRegionJsonBodyDnsServerKeyType0, Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_region_update_region_json_body_dns_server = cls(
            hostname=hostname,
            key=key,
            zone=zone,
        )

        rhub_api_lab_region_update_region_json_body_dns_server.additional_properties = d
        return rhub_api_lab_region_update_region_json_body_dns_server
