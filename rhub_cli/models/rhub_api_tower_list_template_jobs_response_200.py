...
from ..models.rhub_api_tower_list_template_jobs_response_200_data_item import (
...
class RhubApiTowerListTemplateJobsResponse200:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_tower_list_template_jobs_response_200 = cls(
            data=data,
            total=total,
        )

        rhub_api_tower_list_template_jobs_response_200.additional_properties = d
        return rhub_api_tower_list_template_jobs_response_200
