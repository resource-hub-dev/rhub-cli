...
from ..models.rhub_api_tower_update_server_json_body_id import RhubApiTowerUpdateServerJsonBodyId
...
class RhubApiTowerUpdateServerJsonBody:
    ...
    id: Union[Unset, RhubApiTowerUpdateServerJsonBodyId] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_tower_update_server_json_body = cls(
        ...
        rhub_api_tower_update_server_json_body.additional_properties = d
        return rhub_api_tower_update_server_json_body
