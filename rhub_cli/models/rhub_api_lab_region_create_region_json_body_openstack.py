...
from ..models.rhub_api_lab_region_create_region_json_body_openstack_credentials_type_0 import (
    RhubApiLabRegionCreateRegionJsonBodyOpenstackCredentialsType0,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RhubApiLabRegionCreateRegionJsonBodyOpenstack")


@attr.s(auto_attribs=True)
class RhubApiLabRegionCreateRegionJsonBodyOpenstack:
    """
    Attributes:
        credentials (Union[RhubApiLabRegionCreateRegionJsonBodyOpenstackCredentialsType0, Unset, str]):  Example:
    ...
    credentials: Union[RhubApiLabRegionCreateRegionJsonBodyOpenstackCredentialsType0, Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.credentials, RhubApiLabRegionCreateRegionJsonBodyOpenstackCredentialsType0):
            credentials = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_credentials(
            data: object,
        ) -> Union[RhubApiLabRegionCreateRegionJsonBodyOpenstackCredentialsType0, Unset, str]:
            ...
            try:
                ...
                credentials_type_0: Union[Unset, RhubApiLabRegionCreateRegionJsonBodyOpenstackCredentialsType0]
                if isinstance(_credentials_type_0, Unset):
                    credentials_type_0 = UNSET
                else:
                    credentials_type_0 = RhubApiLabRegionCreateRegionJsonBodyOpenstackCredentialsType0.from_dict(
                        _credentials_type_0
                    )
                ...
                pass
            return cast(Union[RhubApiLabRegionCreateRegionJsonBodyOpenstackCredentialsType0, Unset, str], data)
        ...
        rhub_api_lab_region_create_region_json_body_openstack = cls(
        ...
        rhub_api_lab_region_create_region_json_body_openstack.additional_properties = d
        return rhub_api_lab_region_create_region_json_body_openstack
