...
from ..models.rhub_api_openstack_cloud_get_response_200_credentials_type_0 import (
    RhubApiOpenstackCloudGetResponse200CredentialsType0,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RhubApiOpenstackCloudGetResponse200")


@attr.s(auto_attribs=True)
class RhubApiOpenstackCloudGetResponse200:
    """
    Attributes:
        credentials (Union[RhubApiOpenstackCloudGetResponse200CredentialsType0, Unset, str]):  Example:
    ...
    credentials: Union[RhubApiOpenstackCloudGetResponse200CredentialsType0, Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.credentials, RhubApiOpenstackCloudGetResponse200CredentialsType0):
            credentials = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_credentials(data: object) -> Union[RhubApiOpenstackCloudGetResponse200CredentialsType0, Unset, str]:
            ...
            try:
                ...
                credentials_type_0: Union[Unset, RhubApiOpenstackCloudGetResponse200CredentialsType0]
                if isinstance(_credentials_type_0, Unset):
                    credentials_type_0 = UNSET
                else:
                    credentials_type_0 = RhubApiOpenstackCloudGetResponse200CredentialsType0.from_dict(
                        _credentials_type_0
                    )
                ...
                pass
            return cast(Union[RhubApiOpenstackCloudGetResponse200CredentialsType0, Unset, str], data)
        ...
        rhub_api_openstack_cloud_get_response_200 = cls(
        ...
        rhub_api_openstack_cloud_get_response_200.additional_properties = d
        return rhub_api_openstack_cloud_get_response_200
