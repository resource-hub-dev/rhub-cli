...
class RhubApiAuthGroupUpdateGroupJsonBody:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_auth_group_update_group_json_body = cls(
            attributes=attributes,
            id=id,
            name=name,
        )

        rhub_api_auth_group_update_group_json_body.additional_properties = d
        return rhub_api_auth_group_update_group_json_body
