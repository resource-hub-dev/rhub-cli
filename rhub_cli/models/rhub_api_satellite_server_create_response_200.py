...
class RhubApiSatelliteServerCreateResponse200:
    """
    Attributes:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.credentials, RhubApiSatelliteServerCreateResponse200CredentialsType0):
            credentials = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_credentials(
            data: object,
        ) -> Union[RhubApiSatelliteServerCreateResponse200CredentialsType0, Unset, str]:
            ...
            try:
                ...
                credentials_type_0: Union[Unset, RhubApiSatelliteServerCreateResponse200CredentialsType0]
                if isinstance(_credentials_type_0, Unset):
                    credentials_type_0 = UNSET
                else:
                    credentials_type_0 = RhubApiSatelliteServerCreateResponse200CredentialsType0.from_dict(
                        _credentials_type_0
                    )
                ...
                pass
            return cast(Union[RhubApiSatelliteServerCreateResponse200CredentialsType0, Unset, str], data)
        ...
        rhub_api_satellite_server_create_response_200 = cls(
        ...
        rhub_api_satellite_server_create_response_200.additional_properties = d
        return rhub_api_satellite_server_create_response_200
