...
from ..models.rhub_api_lab_region_get_region_response_200_dns_server_key_type_0 import (
...
class RhubApiLabRegionGetRegionResponse200DnsServer:
    ...
    Attributes:
        ...
        key (Union[RhubApiLabRegionGetRegionResponse200DnsServerKeyType0, Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_region_get_region_response_200_dns_server = cls(
            hostname=hostname,
            key=key,
            zone=zone,
        )

        rhub_api_lab_region_get_region_response_200_dns_server.additional_properties = d
        return rhub_api_lab_region_get_region_response_200_dns_server
