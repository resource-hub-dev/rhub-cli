...
from ..models.rhub_api_lab_cluster_list_clusters_response_200_data_item_hosts_item import (
    RhubApiLabClusterListClustersResponse200DataItemHostsItem,
)
from ..models.rhub_api_lab_cluster_list_clusters_response_200_data_item_id import (
    RhubApiLabClusterListClustersResponse200DataItemId,
)
from ..models.rhub_api_lab_cluster_list_clusters_response_200_data_item_product_params import (
    RhubApiLabClusterListClustersResponse200DataItemProductParams,
)
from ..models.rhub_api_lab_cluster_list_clusters_response_200_data_item_quota_type_0 import (
    RhubApiLabClusterListClustersResponse200DataItemQuotaType0,
)
from ..models.rhub_api_lab_cluster_list_clusters_response_200_data_item_quota_usage_type_0 import (
    RhubApiLabClusterListClustersResponse200DataItemQuotaUsageType0,
)
from ..models.rhub_api_lab_cluster_list_clusters_response_200_data_item_status import (
    RhubApiLabClusterListClustersResponse200DataItemStatus,
)
from ..models.rhub_api_lab_cluster_list_clusters_response_200_data_item_status_flag import (
...
class RhubApiLabClusterListClustersResponse200DataItem:
    ...
    Attributes:
        ...
        status_flag (Union[Unset, RhubApiLabClusterListClustersResponse200DataItemStatusFlag]):
    ...
    status_flag: Union[Unset, RhubApiLabClusterListClustersResponse200DataItemStatusFlag] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_quota(data: object) -> Union[Any, RhubApiLabClusterListClustersResponse200DataItemQuotaType0, Unset]:
            ...
            try:
                ...
                pass
            return cast(Union[Any, RhubApiLabClusterListClustersResponse200DataItemQuotaType0, Unset], data)
        ...
        def _parse_quota_usage(
            ...
            try:
                ...
                pass
            return cast(Union[Any, RhubApiLabClusterListClustersResponse200DataItemQuotaUsageType0, Unset], data)
        ...
        if isinstance(_status_flag, Unset):
            ...
            status_flag = RhubApiLabClusterListClustersResponse200DataItemStatusFlag.from_dict(_status_flag)

        user_id = d.pop("user_id", UNSET)

        user_name = d.pop("user_name", UNSET)

        rhub_api_lab_cluster_list_clusters_response_200_data_item = cls(
            created=created,
        ...
        rhub_api_lab_cluster_list_clusters_response_200_data_item.additional_properties = d
        return rhub_api_lab_cluster_list_clusters_response_200_data_item
