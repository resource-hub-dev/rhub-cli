...
class RhubApiLabProductListProductsFilter:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_product_list_products_filter = cls(
            enabled=enabled,
            name=name,
        )

        rhub_api_lab_product_list_products_filter.additional_properties = d
        return rhub_api_lab_product_list_products_filter
