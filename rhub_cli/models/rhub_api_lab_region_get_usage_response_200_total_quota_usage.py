...
T = TypeVar("T", bound="RhubApiLabRegionGetUsageResponse200TotalQuotaUsage")


@attr.s(auto_attribs=True)
class RhubApiLabRegionGetUsageResponse200TotalQuotaUsage:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_region_get_usage_response_200_total_quota_usage = cls(
            num_vcpus=num_vcpus,
        ...
        rhub_api_lab_region_get_usage_response_200_total_quota_usage.additional_properties = d
        return rhub_api_lab_region_get_usage_response_200_total_quota_usage
