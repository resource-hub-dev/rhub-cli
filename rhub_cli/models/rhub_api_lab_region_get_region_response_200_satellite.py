...
from ..models.rhub_api_lab_region_get_region_response_200_satellite_credentials_type_0 import (
...
class RhubApiLabRegionGetRegionResponse200Satellite:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.credentials, RhubApiLabRegionGetRegionResponse200SatelliteCredentialsType0):
            credentials = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_region_get_region_response_200_satellite = cls(
            credentials=credentials,
            hostname=hostname,
            insecure=insecure,
        )

        rhub_api_lab_region_get_region_response_200_satellite.additional_properties = d
        return rhub_api_lab_region_get_region_response_200_satellite
