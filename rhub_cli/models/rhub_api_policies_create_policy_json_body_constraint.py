...
class RhubApiPoliciesCreatePolicyJsonBodyConstraint:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_policies_create_policy_json_body_constraint = cls(
            cost=cost,
            density=density,
            limit=limit,
            location=location,
        ...
        rhub_api_policies_create_policy_json_body_constraint.additional_properties = d
        return rhub_api_policies_create_policy_json_body_constraint
