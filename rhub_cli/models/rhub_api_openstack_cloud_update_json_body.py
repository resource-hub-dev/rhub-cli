...
from ..models.rhub_api_openstack_cloud_update_json_body_credentials_type_0 import (
    RhubApiOpenstackCloudUpdateJsonBodyCredentialsType0,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RhubApiOpenstackCloudUpdateJsonBody")


@attr.s(auto_attribs=True)
class RhubApiOpenstackCloudUpdateJsonBody:
    """
    Attributes:
        credentials (Union[RhubApiOpenstackCloudUpdateJsonBodyCredentialsType0, Unset, str]):  Example:
    ...
    credentials: Union[RhubApiOpenstackCloudUpdateJsonBodyCredentialsType0, Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.credentials, RhubApiOpenstackCloudUpdateJsonBodyCredentialsType0):
            credentials = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_credentials(data: object) -> Union[RhubApiOpenstackCloudUpdateJsonBodyCredentialsType0, Unset, str]:
            ...
            try:
                ...
                credentials_type_0: Union[Unset, RhubApiOpenstackCloudUpdateJsonBodyCredentialsType0]
                if isinstance(_credentials_type_0, Unset):
                    credentials_type_0 = UNSET
                else:
                    credentials_type_0 = RhubApiOpenstackCloudUpdateJsonBodyCredentialsType0.from_dict(
                        _credentials_type_0
                    )
                ...
                pass
            return cast(Union[RhubApiOpenstackCloudUpdateJsonBodyCredentialsType0, Unset, str], data)
        ...
        rhub_api_openstack_cloud_update_json_body = cls(
        ...
        rhub_api_openstack_cloud_update_json_body.additional_properties = d
        return rhub_api_openstack_cloud_update_json_body
