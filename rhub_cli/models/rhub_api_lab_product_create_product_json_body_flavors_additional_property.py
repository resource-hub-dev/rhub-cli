...
T = TypeVar("T", bound="RhubApiLabProductCreateProductJsonBodyFlavorsAdditionalProperty")


@attr.s(auto_attribs=True)
class RhubApiLabProductCreateProductJsonBodyFlavorsAdditionalProperty:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_product_create_product_json_body_flavors_additional_property = cls(
            num_vcpus=num_vcpus,
        ...
        rhub_api_lab_product_create_product_json_body_flavors_additional_property.additional_properties = d
        return rhub_api_lab_product_create_product_json_body_flavors_additional_property
