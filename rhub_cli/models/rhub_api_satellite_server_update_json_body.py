...
class RhubApiSatelliteServerUpdateJsonBody:
    """
    Attributes:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.credentials, RhubApiSatelliteServerUpdateJsonBodyCredentialsType0):
            credentials = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_credentials(data: object) -> Union[RhubApiSatelliteServerUpdateJsonBodyCredentialsType0, Unset, str]:
            ...
            try:
                ...
                credentials_type_0: Union[Unset, RhubApiSatelliteServerUpdateJsonBodyCredentialsType0]
                if isinstance(_credentials_type_0, Unset):
                    credentials_type_0 = UNSET
                else:
                    credentials_type_0 = RhubApiSatelliteServerUpdateJsonBodyCredentialsType0.from_dict(
                        _credentials_type_0
                    )
                ...
                pass
            return cast(Union[RhubApiSatelliteServerUpdateJsonBodyCredentialsType0, Unset, str], data)
        ...
        rhub_api_satellite_server_update_json_body = cls(
        ...
        rhub_api_satellite_server_update_json_body.additional_properties = d
        return rhub_api_satellite_server_update_json_body
