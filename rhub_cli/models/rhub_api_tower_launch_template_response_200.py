...
class RhubApiTowerLaunchTemplateResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_tower_launch_template_response_200 = cls(
        ...
        rhub_api_tower_launch_template_response_200.additional_properties = d
        return rhub_api_tower_launch_template_response_200
