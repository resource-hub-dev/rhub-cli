...
from ..models.rhub_api_lab_cluster_update_cluster_json_body_quota_type_0 import (
    RhubApiLabClusterUpdateClusterJsonBodyQuotaType0,
)
from ..models.rhub_api_lab_cluster_update_cluster_json_body_quota_usage_type_0 import (
...
class RhubApiLabClusterUpdateClusterJsonBody:
    ...
    Attributes:
        ...
        status_flag (Union[Unset, None, RhubApiLabClusterUpdateClusterJsonBodyStatusFlag]):
    """
    ...
    status_flag: Union[Unset, None, RhubApiLabClusterUpdateClusterJsonBodyStatusFlag] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_quota(data: object) -> Union[Any, RhubApiLabClusterUpdateClusterJsonBodyQuotaType0, Unset]:
            ...
            try:
                ...
                pass
            return cast(Union[Any, RhubApiLabClusterUpdateClusterJsonBodyQuotaType0, Unset], data)
        ...
        def _parse_quota_usage(
            ...
            try:
                ...
                pass
            return cast(Union[Any, RhubApiLabClusterUpdateClusterJsonBodyQuotaUsageType0, Unset], data)
        ...
        if _status_flag is None:
            ...
            status_flag = RhubApiLabClusterUpdateClusterJsonBodyStatusFlag(_status_flag)

        rhub_api_lab_cluster_update_cluster_json_body = cls(
            created=created,
        ...
        rhub_api_lab_cluster_update_cluster_json_body.additional_properties = d
        return rhub_api_lab_cluster_update_cluster_json_body
