...
class RhubApiAuthUserGetUserResponse200:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_auth_user_get_user_response_200 = cls(
            email=email,
            enabled=enabled,
        ...
        rhub_api_auth_user_get_user_response_200.additional_properties = d
        return rhub_api_auth_user_get_user_response_200
