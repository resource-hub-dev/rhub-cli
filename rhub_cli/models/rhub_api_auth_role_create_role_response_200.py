...
class RhubApiAuthRoleCreateRoleResponse200:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_auth_role_create_role_response_200 = cls(
            attributes=attributes,
            id=id,
            name=name,
        )

        rhub_api_auth_role_create_role_response_200.additional_properties = d
        return rhub_api_auth_role_create_role_response_200
