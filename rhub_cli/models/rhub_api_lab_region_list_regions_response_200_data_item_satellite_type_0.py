...
class RhubApiLabRegionListRegionsResponse200DataItemSatelliteType0:
    """
    Attributes:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.credentials, RhubApiLabRegionListRegionsResponse200DataItemSatelliteType0CredentialsType0):
            credentials = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_credentials(
            data: object,
        ) -> Union[RhubApiLabRegionListRegionsResponse200DataItemSatelliteType0CredentialsType0, Unset, str]:
            ...
            try:
                ...
                credentials_type_0: Union[
                    Unset, RhubApiLabRegionListRegionsResponse200DataItemSatelliteType0CredentialsType0
                ]
                if isinstance(_credentials_type_0, Unset):
                    credentials_type_0 = UNSET
                else:
                    credentials_type_0 = (
                        RhubApiLabRegionListRegionsResponse200DataItemSatelliteType0CredentialsType0.from_dict(
                            _credentials_type_0
                        )
                    )
                ...
                pass
            return cast(
                Union[RhubApiLabRegionListRegionsResponse200DataItemSatelliteType0CredentialsType0, Unset, str], data
            )
        ...
        rhub_api_lab_region_list_regions_response_200_data_item_satellite_type_0 = cls(
        ...
        rhub_api_lab_region_list_regions_response_200_data_item_satellite_type_0.additional_properties = d
        return rhub_api_lab_region_list_regions_response_200_data_item_satellite_type_0
