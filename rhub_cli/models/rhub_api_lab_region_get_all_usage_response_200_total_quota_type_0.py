...
T = TypeVar("T", bound="RhubApiLabRegionGetAllUsageResponse200TotalQuotaType0")


@attr.s(auto_attribs=True)
class RhubApiLabRegionGetAllUsageResponse200TotalQuotaType0:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_region_get_all_usage_response_200_total_quota_type_0 = cls(
            num_vcpus=num_vcpus,
        ...
        rhub_api_lab_region_get_all_usage_response_200_total_quota_type_0.additional_properties = d
        return rhub_api_lab_region_get_all_usage_response_200_total_quota_type_0
