...
T = TypeVar("T", bound="RhubApiMonitorMetricsLabMetricsResponse200DataItem")


@attr.s(auto_attribs=True)
class RhubApiMonitorMetricsLabMetricsResponse200DataItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_monitor_metrics_lab_metrics_response_200_data_item = cls(
            all_=all_,
            available=available,
        ...
        rhub_api_monitor_metrics_lab_metrics_response_200_data_item.additional_properties = d
        return rhub_api_monitor_metrics_lab_metrics_response_200_data_item
