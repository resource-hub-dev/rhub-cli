...
from ..models.rhub_api_lab_region_update_region_json_body_satellite_credentials_type_0 import (
...
class RhubApiLabRegionUpdateRegionJsonBodySatellite:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_region_update_region_json_body_satellite = cls(
            credentials=credentials,
            hostname=hostname,
            insecure=insecure,
        )

        rhub_api_lab_region_update_region_json_body_satellite.additional_properties = d
        return rhub_api_lab_region_update_region_json_body_satellite
