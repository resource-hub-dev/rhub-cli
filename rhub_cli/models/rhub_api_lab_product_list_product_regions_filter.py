...
class RhubApiLabProductListProductRegionsFilter:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_product_list_product_regions_filter = cls(
            enabled=enabled,
            location=location,
            name=name,
        ...
        rhub_api_lab_product_list_product_regions_filter.additional_properties = d
        return rhub_api_lab_product_list_product_regions_filter
