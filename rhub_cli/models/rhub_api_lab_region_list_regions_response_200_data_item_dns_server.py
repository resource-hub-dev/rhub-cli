...
from ..models.rhub_api_lab_region_list_regions_response_200_data_item_dns_server_key_type_0 import (
...
class RhubApiLabRegionListRegionsResponse200DataItemDnsServer:
    ...
    Attributes:
        ...
        key (Union[RhubApiLabRegionListRegionsResponse200DataItemDnsServerKeyType0, Unset, str]):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.key, RhubApiLabRegionListRegionsResponse200DataItemDnsServerKeyType0):
            key = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_region_list_regions_response_200_data_item_dns_server = cls(
            hostname=hostname,
            key=key,
            zone=zone,
        )

        rhub_api_lab_region_list_regions_response_200_data_item_dns_server.additional_properties = d
        return rhub_api_lab_region_list_regions_response_200_data_item_dns_server
