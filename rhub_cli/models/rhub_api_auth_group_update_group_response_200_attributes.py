...
class RhubApiAuthGroupUpdateGroupResponse200Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = copy(src_dict)
        rhub_api_auth_group_update_group_response_200_attributes = cls()
        ...
        rhub_api_auth_group_update_group_response_200_attributes.additional_properties = additional_properties
        return rhub_api_auth_group_update_group_response_200_attributes
