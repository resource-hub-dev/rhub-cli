...
class RhubApiAuthGroupListGroupRolesResponse200Item:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_auth_group_list_group_roles_response_200_item = cls(
            attributes=attributes,
            id=id,
            name=name,
        )

        rhub_api_auth_group_list_group_roles_response_200_item.additional_properties = d
        return rhub_api_auth_group_list_group_roles_response_200_item
