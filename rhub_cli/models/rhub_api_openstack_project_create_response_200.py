...
class RhubApiOpenstackProjectCreateResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_openstack_project_create_response_200 = cls(
            cloud_id=cloud_id,
        ...
        rhub_api_openstack_project_create_response_200.additional_properties = d
        return rhub_api_openstack_project_create_response_200
