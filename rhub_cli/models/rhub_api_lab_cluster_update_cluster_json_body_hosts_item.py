...
from ..models.rhub_api_lab_cluster_update_cluster_json_body_hosts_item_cluster_id import (
    RhubApiLabClusterUpdateClusterJsonBodyHostsItemClusterId,
)
from ..models.rhub_api_lab_cluster_update_cluster_json_body_hosts_item_id import (
...
class RhubApiLabClusterUpdateClusterJsonBodyHostsItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_cluster_update_cluster_json_body_hosts_item = cls(
        ...
        rhub_api_lab_cluster_update_cluster_json_body_hosts_item.additional_properties = d
        return rhub_api_lab_cluster_update_cluster_json_body_hosts_item
