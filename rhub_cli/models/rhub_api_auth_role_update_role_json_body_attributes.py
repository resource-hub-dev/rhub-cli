...
class RhubApiAuthRoleUpdateRoleJsonBodyAttributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = copy(src_dict)
        rhub_api_auth_role_update_role_json_body_attributes = cls()
        ...
        rhub_api_auth_role_update_role_json_body_attributes.additional_properties = additional_properties
        return rhub_api_auth_role_update_role_json_body_attributes
