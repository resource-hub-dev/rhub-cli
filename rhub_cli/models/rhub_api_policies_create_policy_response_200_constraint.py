...
from ..models.rhub_api_policies_create_policy_response_200_constraint_location_type_0 import (
...
class RhubApiPoliciesCreatePolicyResponse200Constraint:
    ...
    Attributes:
        ...
        location (Union[Any, RhubApiPoliciesCreatePolicyResponse200ConstraintLocationType0, Unset]):
    ...
    location: Union[Any, RhubApiPoliciesCreatePolicyResponse200ConstraintLocationType0, Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.location, RhubApiPoliciesCreatePolicyResponse200ConstraintLocationType0):
            location = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_location(
            data: object,
        ) -> Union[Any, RhubApiPoliciesCreatePolicyResponse200ConstraintLocationType0, Unset]:
            ...
            try:
                ...
                location_type_0: Union[Unset, RhubApiPoliciesCreatePolicyResponse200ConstraintLocationType0]
                if isinstance(_location_type_0, Unset):
                    location_type_0 = UNSET
                else:
                    location_type_0 = RhubApiPoliciesCreatePolicyResponse200ConstraintLocationType0.from_dict(
                        _location_type_0
                    )
                ...
                pass
            return cast(Union[Any, RhubApiPoliciesCreatePolicyResponse200ConstraintLocationType0, Unset], data)
