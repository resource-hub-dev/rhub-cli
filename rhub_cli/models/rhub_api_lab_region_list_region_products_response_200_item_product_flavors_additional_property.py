...
T = TypeVar("T", bound="RhubApiLabRegionListRegionProductsResponse200ItemProductFlavorsAdditionalProperty")


@attr.s(auto_attribs=True)
class RhubApiLabRegionListRegionProductsResponse200ItemProductFlavorsAdditionalProperty:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_region_list_region_products_response_200_item_product_flavors_additional_property = cls(
            num_vcpus=num_vcpus,
        ...
        rhub_api_lab_region_list_region_products_response_200_item_product_flavors_additional_property.additional_properties = (
            d
        )
        return rhub_api_lab_region_list_region_products_response_200_item_product_flavors_additional_property
