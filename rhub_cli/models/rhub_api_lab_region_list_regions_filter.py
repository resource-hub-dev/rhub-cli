...
class RhubApiLabRegionListRegionsFilter:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_region_list_regions_filter = cls(
            enabled=enabled,
            location=location,
            name=name,
        ...
        rhub_api_lab_region_list_regions_filter.additional_properties = d
        return rhub_api_lab_region_list_regions_filter
