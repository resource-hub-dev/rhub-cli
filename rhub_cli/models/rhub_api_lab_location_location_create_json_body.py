...
class RhubApiLabLocationLocationCreateJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_location_location_create_json_body.additional_properties = d
        return rhub_api_lab_location_location_create_json_body
