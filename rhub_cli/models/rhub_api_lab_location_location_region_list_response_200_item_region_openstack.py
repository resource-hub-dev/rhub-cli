...
from ..models.rhub_api_lab_location_location_region_list_response_200_item_region_openstack_credentials_type_0 import (
    RhubApiLabLocationLocationRegionListResponse200ItemRegionOpenstackCredentialsType0,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="RhubApiLabLocationLocationRegionListResponse200ItemRegionOpenstack")


@attr.s(auto_attribs=True)
class RhubApiLabLocationLocationRegionListResponse200ItemRegionOpenstack:
    """
    Attributes:
        credentials (Union[RhubApiLabLocationLocationRegionListResponse200ItemRegionOpenstackCredentialsType0, Unset,
            str]):  Example: kv/openstack/rhub-rdu.
    ...
    credentials: Union[
        RhubApiLabLocationLocationRegionListResponse200ItemRegionOpenstackCredentialsType0, Unset, str
    ] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.credentials, Unset):
            ...
            self.credentials, RhubApiLabLocationLocationRegionListResponse200ItemRegionOpenstackCredentialsType0
        ):
            credentials = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_credentials(
            data: object,
        ) -> Union[RhubApiLabLocationLocationRegionListResponse200ItemRegionOpenstackCredentialsType0, Unset, str]:
            ...
            try:
                ...
                credentials_type_0: Union[
                    Unset, RhubApiLabLocationLocationRegionListResponse200ItemRegionOpenstackCredentialsType0
                ]
                if isinstance(_credentials_type_0, Unset):
                    credentials_type_0 = UNSET
                else:
                    credentials_type_0 = (
                        RhubApiLabLocationLocationRegionListResponse200ItemRegionOpenstackCredentialsType0.from_dict(
                            _credentials_type_0
                        )
                    )
        ...
        rhub_api_lab_location_location_region_list_response_200_item_region_openstack = cls(
        ...
        rhub_api_lab_location_location_region_list_response_200_item_region_openstack.additional_properties = d
        return rhub_api_lab_location_location_region_list_response_200_item_region_openstack
