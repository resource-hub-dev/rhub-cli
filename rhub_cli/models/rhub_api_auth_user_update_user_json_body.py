...
from ..models.rhub_api_auth_user_update_user_json_body_id import RhubApiAuthUserUpdateUserJsonBodyId
...
class RhubApiAuthUserUpdateUserJsonBody:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_auth_user_update_user_json_body = cls(
            email=email,
            enabled=enabled,
        ...
        rhub_api_auth_user_update_user_json_body.additional_properties = d
        return rhub_api_auth_user_update_user_json_body
