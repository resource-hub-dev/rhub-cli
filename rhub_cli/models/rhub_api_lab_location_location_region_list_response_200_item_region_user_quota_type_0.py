...
T = TypeVar("T", bound="RhubApiLabLocationLocationRegionListResponse200ItemRegionUserQuotaType0")


@attr.s(auto_attribs=True)
class RhubApiLabLocationLocationRegionListResponse200ItemRegionUserQuotaType0:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_location_location_region_list_response_200_item_region_user_quota_type_0 = cls(
            num_vcpus=num_vcpus,
        ...
        rhub_api_lab_location_location_region_list_response_200_item_region_user_quota_type_0.additional_properties = d
        return rhub_api_lab_location_location_region_list_response_200_item_region_user_quota_type_0
