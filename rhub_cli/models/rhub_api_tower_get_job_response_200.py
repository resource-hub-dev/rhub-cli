...
from ..models.rhub_api_tower_get_job_response_200_id import RhubApiTowerGetJobResponse200Id
from ..types import UNSET, Unset

T = TypeVar("T", bound="RhubApiTowerGetJobResponse200")
...
class RhubApiTowerGetJobResponse200:
    ...
    id: Union[Unset, RhubApiTowerGetJobResponse200Id] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _id = d.pop("id", UNSET)
        id: Union[Unset, RhubApiTowerGetJobResponse200Id]
        if isinstance(_id, Unset):
            id = UNSET
        else:
            id = RhubApiTowerGetJobResponse200Id.from_dict(_id)
        ...
        rhub_api_tower_get_job_response_200 = cls(
        ...
        rhub_api_tower_get_job_response_200.additional_properties = d
        return rhub_api_tower_get_job_response_200
