...
class RhubApiTowerListServersResponse200DataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_tower_list_servers_response_200_data_item = cls(
        ...
        rhub_api_tower_list_servers_response_200_data_item.additional_properties = d
        return rhub_api_tower_list_servers_response_200_data_item
