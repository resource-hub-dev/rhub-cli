...
T = TypeVar("T", bound="RhubApiOpenstackProjectListResponse200DataItem")


@attr.s(auto_attribs=True)
class RhubApiOpenstackProjectListResponse200DataItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_openstack_project_list_response_200_data_item = cls(
            cloud_id=cloud_id,
        ...
        rhub_api_openstack_project_list_response_200_data_item.additional_properties = d
        return rhub_api_openstack_project_list_response_200_data_item
