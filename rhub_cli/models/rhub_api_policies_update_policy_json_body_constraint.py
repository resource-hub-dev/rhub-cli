...
from ..models.rhub_api_policies_update_policy_json_body_constraint_limit import (
    RhubApiPoliciesUpdatePolicyJsonBodyConstraintLimit,
)
from ..models.rhub_api_policies_update_policy_json_body_constraint_location_type_0 import (
...
class RhubApiPoliciesUpdatePolicyJsonBodyConstraint:
    ...
    Attributes:
        ...
        location (Union[Any, RhubApiPoliciesUpdatePolicyJsonBodyConstraintLocationType0, Unset]):
    ...
    location: Union[Any, RhubApiPoliciesUpdatePolicyJsonBodyConstraintLocationType0, Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.location, RhubApiPoliciesUpdatePolicyJsonBodyConstraintLocationType0):
            location = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_location(
            data: object,
        ) -> Union[Any, RhubApiPoliciesUpdatePolicyJsonBodyConstraintLocationType0, Unset]:
            ...
            try:
                ...
                location_type_0: Union[Unset, RhubApiPoliciesUpdatePolicyJsonBodyConstraintLocationType0]
                if isinstance(_location_type_0, Unset):
                    location_type_0 = UNSET
                else:
                    location_type_0 = RhubApiPoliciesUpdatePolicyJsonBodyConstraintLocationType0.from_dict(
                        _location_type_0
                    )
                ...
                pass
            return cast(Union[Any, RhubApiPoliciesUpdatePolicyJsonBodyConstraintLocationType0, Unset], data)
        ...
        rhub_api_policies_update_policy_json_body_constraint = cls(
            cost=cost,
            density=density,
            limit=limit,
            location=location,
        ...
        rhub_api_policies_update_policy_json_body_constraint.additional_properties = d
        return rhub_api_policies_update_policy_json_body_constraint
